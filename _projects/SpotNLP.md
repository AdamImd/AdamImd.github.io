...
<div class="row justify-content-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include video.liquid path="https://drive.google.com/file/d/1gJQImMGEnGH4fOe8TpPvDU1NuAJ4rH7D/preview" class="img-fluid rounded z-depth-1" height="400" controls=true autoplay=true %}
    </div>
</div>
