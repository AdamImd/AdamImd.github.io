...
These assets support the project's public portfolio pages. Captions on each page identify simulations, CAD, diagnostic plots, and published demonstrations. They should not be reused as evidence of hardware performance without the corresponding study record.

| Files | Source and interpretation |
| --- | --- |
